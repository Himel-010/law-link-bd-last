...
postSchema.index({ client: 1, status: 1, createdAt: -1, _id: -1 });
postSchema.index({ category: 1, status: 1, createdAt: -1, _id: -1 });
postSchema.index({ status: 1, isPriority: -1, createdAt: -1, _id: -1 });
